    ...
    function generateSVG(string memory name) public pure returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                '<g id="Username.hype">',
                // Domain name with dot centered horizontally
                '<text id="domain-name" fill="black" xml:space="preserve" style="white-space: pre" font-family="Feature Text" font-size="58.4413" letter-spacing="0em" text-anchor="middle" x="537" y="999.831">',
                displayName,
                ".hype</text>",
                "</g>",
