...
contract DotHypeMerkleMintTest is Test {
    ...
    function testMerkleProofMinting() public {
        ...
        (uint256 tokenId, uint256 expiry) =
            controller.registerWithMerkleProof{value: price}(name, duration, proofs[user1]);
    ...
    function testNonWhitelistedMinting() public {
        ...
        controller.registerWithMerkleProof{value: price}(name, duration, fakeProof);
    }
    ...
    function testReservedNameMerkleMinting() public {
        ...
        vm.prank(user1);
        vm.expectRevert(
            abi.encodeWithSelector(DotHypeController.NameIsReserved.selector, keccak256(bytes(name)), user4)
        );
        controller.registerWithMerkleProof{value: price}(name, duration, proofs[user1]);
    ...
    function testCannotMintMultipleDomainsWithSameProof() public {
        ...
        // First mint
        vm.prank(user1);
        controller.registerWithMerkleProof{value: price}(name1, duration, proofs[user1]);
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(DotHypeController.AlreadyMinted.selector, user1));
        controller.registerWithMerkleProof{value: price}(name2, duration, proofs[user1]);
    }
    ...
    function testResetMerkleProofUsage() public {
        ...
        // First mint
        vm.prank(user1);
        (uint256 tokenId1,) = controller.registerWithMerkleProof{value: price}(name1, duration, proofs[user1]);
        ...
        vm.prank(user1);
        (uint256 tokenId2,) = controller.registerWithMerkleProof{value: price}(name2, duration, proofs[user1]);
